...
<div class="login-box">
  ...
  <div class="login-box-body">
      ...
      ?>
    <h3 class="login-box-msg">Enter Your Info</h3>

    <form action="../php/process.php" method="post">
      <div class="form-group has-feedback">
        <select class="form-control" name="bypass_subject">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Matric No" name="matric_no" required="required">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-6">
          <button type="submit" class="btn btn-primary btn-block btn-flat"  name="mark_attend">MARK ATTENDANCE</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
