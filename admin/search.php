...
<div class="login-box">
  ...
  <?php
      ...
      ?>
    <p class="login-box-msg"><h3>Select Attendance to view</h3></p>

    <form action="../php/process.php" method="post">
    <div class="form-group has-feedback">
        <select class="form-control" name="reg_subject" required="">
    ...
    <div class="form-group has-feedback">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-primary btn-block btn-flat"  name="search">search</button>
        </div>
        <a href="setquestion.php" class="btn btn-primary">Set Question</a>
        <!-- /.col -->
      </div>
    </form>
